...
import { ArrowLeft, ChevronDown, ChevronUp, Plus, Trash2, Save, Users } from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-2xl mx-auto px-4 py-6">
        ...
        <div className="flex items-center gap-3 mb-6">
          <Link href="/team/schedule" className="text-muted hover:text-foreground">
            <ArrowLeft className="h-5 w-5" />
          </Link>
          <div>
            <h1 className="text-lg font-bold">Parent Registration</h1>
        ...
        {playerList.length === 0 ? (
          ...
          <div className="space-y-2">
            {playerList.map((player) => {
              ...
              // Don't show duplicate family expansions for siblings
              const isFirstSibling =
                playerList.findIndex((p) => p.family.id === player.family.id) ===
                  ...
                  {isExpanded && isFirstSibling && (
                    <div className="mt-1 border border-border rounded-lg bg-card p-4 space-y-4">
                      ...
                      <div>
                        ...
                        {player.family.contacts.length === 0 &&
                          !showAddContact && (
                            <p className="text-xs text-muted py-2">
                              No additional contacts yet. Add a second parent,
                              grandparent, or emergency contact.
                            </p>
                          )}
                          ...
                          <div className="border border-border rounded-lg p-3 mt-2 space-y-3">
                            ...
                            <div className="flex gap-2">
                              <Button
                                size="sm"
                                onClick={() =>
                                  handleAddContact(player.family.id)
                                }
